...
def calculate_highest_degree(path, job_title_name, job_title_data_path, extract_number):
    with open(
            job_title_data_path,
            'r') as csvfile:
        name = job_title_name
        ...
        writer = csv.writer(
            open(path + globalparameter.output_file_header_job_title+ globalparameter.name_for_search_highest_degree + globalparameter.output_file_root, 'w'))
...
def calculate_work_year(path, job_title_name,job_title_data_path,extract_number):
    ...
    with open(
        ...
        i = 1
        writer = csv.writer(
            open(path + globalparameter.output_file_header_job_title+ globalparameter.name_for_search_work_year + globalparameter.output_file_root, 'w'))
        for row in itertools.islice(reader, extract_number):
            # print(i)
