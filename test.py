...
with open('/Users/pengyuzhou/Desktop/content_based_software_engineer/software_engineer_work_year_lowercase_no_punctuation.csv', 'r') as f:
    reader = csv.reader(f)
    writer = csv.writer(open('/Users/pengyuzhou/Desktop/content_based_software_engineer/software_engineer_work_year_normalize_test.csv', 'w'))
