...
def calculate_work_exp_times(path, name_for_search, job_title_name, input_file_path):
    with open(
            input_file_path,
            'r') as csvfile:
        name = job_title_name
        ...
        counter = 1
        writer = csv.writer(open(path + globalparameter.output_file_header_job_title + name_for_search + globalparameter.output_file_root, 'w'))
