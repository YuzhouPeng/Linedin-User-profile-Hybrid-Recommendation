...
if __name__ == '__main__':
    ...
    for k in range(5):
        ...
        for i in range(6):
            ...
            alg_decision_tree.decision_tree(globalparameter.folderpath[i], globalparameter.jobtitle_path_list[i], 0.5,j)
            alg_ramdom_forest.random_forest(globalparameter.folderpath[i], globalparameter.jobtitle_path_list[i], 0.5,j)
            j = j+8
            print('------------')
